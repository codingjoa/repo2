...
module.exports = async function(
  ...
  pool.query(
    'update student set studentName=(?), studentBirthday=(?), studentGender=(?), studentPhone=(?), studentEmail=(?), studentAddress=(?) where studentID=(?)',
    [ studentName, studentBirthday, studentGender, studentPhone, studentEmail, studentAddress, studentID ]
  )
  .then(r => {
